...
32 RX_REFCLK_FREQUENCY 100} \
    ...
    CONFIG.INTF0_PARENTID {versal_gen2_platform_pcie_phy_1} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch0_phyready  [get_bd_pins gtwiz_versal_0/QUAD1_ch0_phyready] \
  [get_bd_pins pcie_phy/ch4_phyready]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch0_phystatus  [get_bd_pins gtwiz_versal_0/QUAD1_ch0_phystatus] \
  [get_bd_pins pcie_phy/ch4_phystatus]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch1_phyready  [get_bd_pins gtwiz_versal_0/QUAD1_ch1_phyready] \
  [get_bd_pins pcie_phy/ch5_phyready]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch1_phystatus  [get_bd_pins gtwiz_versal_0/QUAD1_ch1_phystatus] \
  [get_bd_pins pcie_phy/ch5_phystatus]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch2_phyready  [get_bd_pins gtwiz_versal_0/QUAD1_ch2_phyready] \
  [get_bd_pins pcie_phy/ch6_phyready]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch2_phystatus  [get_bd_pins gtwiz_versal_0/QUAD1_ch2_phystatus] \
  [get_bd_pins pcie_phy/ch6_phystatus]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch3_phyready  [get_bd_pins gtwiz_versal_0/QUAD1_ch3_phyready] \
  [get_bd_pins pcie_phy/ch7_phyready]
  connect_bd_net -net gtwiz_versal_0_QUAD1_ch3_phystatus  [get_bd_pins gtwiz_versal_0/QUAD1_ch3_phystatus] \
...
proc create_hier_cell_pl_pcie { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins qdma_0_support/pcie_mgt] [get_bd_intf_pins pcie_mgt]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins qdma_0_support/pcie_refclk] [get_bd_intf_pins pcie_refclk]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins qdma_0/S_AXI_LITE_CSR]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins pcie_reg_space_0/S01_AXI] [get_bd_intf_pins smartconnect_0/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins qdma_0/axi_aresetn] \
  [get_bd_pins pcie_reg_space_0/s00_axi_aresetn] \
  [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net Net1  [get_bd_pins aclk] \
  [get_bd_pins smartconnect_0/aclk] \
  [get_bd_pins pcie_reg_space_0/s01_axi_aclk]
  connect_bd_net -net Net2  [get_bd_pins aresetn] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins pcie_reg_space_0/s01_axi_aresetn]
  connect_bd_net -net ilconcat_0_dout  [get_bd_pins ilconcat_0/dout] \
  [get_bd_pins qdma_0/usr_irq_in_fnc]
  ...
  connect_bd_net -net pcie_reg_space_0_IRQ1_to_Host  [get_bd_pins pcie_reg_space_0/IRQ1_to_Host] \
  [get_bd_pins ilconcat_0/In0]
  connect_bd_net -net pcie_reg_space_0_IRQ1_to_PS  [get_bd_pins pcie_reg_space_0/IRQ1_to_PS] \
  [get_bd_pins IRQ1_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ2_to_PS  [get_bd_pins pcie_reg_space_0/IRQ2_to_PS] \
  [get_bd_pins IRQ2_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ3_to_PS  [get_bd_pins pcie_reg_space_0/IRQ3_to_PS] \
  [get_bd_pins IRQ3_to_PS]
  connect_bd_net -net pcie_reg_space_0_IRQ4_to_PS  [get_bd_pins pcie_reg_space_0/IRQ4_to_PS] \
  [get_bd_pins IRQ4_to_PS]
  connect_bd_net -net qdma_0_axi_aclk  [get_bd_pins qdma_0/axi_aclk] \
  [get_bd_pins axi_noc2_0/aclk0] \
  [get_bd_pins smartconnect_1/aclk] \
  [get_bd_pins pcie_reg_space_0/s00_axi_aclk] \
  ...
  assign_bd_address -offset 0x080250000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces $hier_obj/qdma_0/M_AXI] [get_bd_addr_segs $hier_obj/pcie_reg_space_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x080250000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces $hier_obj/qdma_0/M_AXI_BRIDGE] [get_bd_addr_segs $hier_obj/pcie_reg_space_0/S00_AXI/S00_AXI_reg] -force

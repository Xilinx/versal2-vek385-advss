...
proc create_hier_cell_hdmi_tx_ss_hier { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CONNECTIONS {M00_INI {read_bw {1100} write_bw {0} }} \
    CONFIG.DEST_IDS {} \
    CONFIG.NOC_PARAMS {} \
    CONFIG.CATEGORY {pl} \
  ...
  set_property -dict [list \
    CONFIG.DATA_WIDTH {512} \
    CONFIG.CONNECTIONS {M01_INI {read_bw {1100} write_bw {0} }} \
    CONFIG.DEST_IDS {} \
    CONFIG.NOC_PARAMS {} \
    CONFIG.CATEGORY {pl} \
  ...
  set_property -dict [list \
    CONFIG.DATA_WIDTH {512} \
    CONFIG.CONNECTIONS {M02_INI {read_bw {1100} write_bw {0} }} \
    CONFIG.DEST_IDS {} \
    CONFIG.NOC_PARAMS {} \
    CONFIG.CATEGORY {pl} \
  ...
  set_property -dict [list \
    CONFIG.DATA_WIDTH {512} \
    CONFIG.CONNECTIONS {M03_INI {read_bw {1100} write_bw {0} }} \
    CONFIG.DEST_IDS {} \
    CONFIG.NOC_PARAMS {} \
    CONFIG.CATEGORY {pl} \
  ...
  create_bd_cell -type ip -vlnv xilinx.com:ip:v_mix v_mix_0
  set_property -dict [list \
  ...
  connect_bd_net -net Net [get_bd_pins Op1] [get_bd_pins clkx_wiz_0/resetn] [get_bd_pins rst_processor_1_100M/ext_reset_in]
  ...
  connect_bd_net -net ilconstant_1_dout [get_bd_pins ilconstant_1/dout] [get_bd_pins v_mix_0/s_axis_video_TVALID] [get_bd_pins v_mix_0/s_axis_video_TDATA]
  connect_bd_net -net ilslice_5_Dout [get_bd_pins ilslice_5/Dout] [get_bd_pins v_mix_0/ap_rst_n]
  ...
  connect_bd_net -net net_cips_ss_0_clk_out2 [get_bd_pins clk_300] [get_bd_pins tx_video_axis_reg_slice/aclk] [get_bd_pins v_fifo_dc/rstn_clk] [get_bd_pins axi_gpio/s_axi_aclk] [get_bd_pins axi_noc2_0/aclk0] [get_bd_pins axi_smartconnect_0/aclk1] [get_bd_pins v_hdmi_txss1/s_axis_video_aclk] [get_bd_pins v_mix_0/ap_clk] [get_bd_pins rst_processor_1_300M/slowest_sync_clk]
  ...
  connect_bd_net -net net_clkx_wiz_0_locked [get_bd_pins clkx_wiz_0/locked] [get_bd_pins rst_processor_1_300M/ext_reset_in] [get_bd_pins rst_processor_1_300M/dcm_locked] [get_bd_pins rst_processor_1_300M/aux_reset_in]
  ...
  connect_bd_net -net ps_wizard_0_pl0_ref_clk [get_bd_pins clk_100] [get_bd_pins hdmiphy_ss_0/vid_phy_sb_aclk] [get_bd_pins hdmiphy_ss_0/vid_phy_axi4lite_aclk] [get_bd_pins vfmc_ctlr_ss_0/s_axi_aclk] [get_bd_pins hdmiphy_ss_0/drpclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_smartconnect_0/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clkx_wiz_0/clk_in1] [get_bd_pins v_hdmi_txss1/s_axi_cpu_aclk] [get_bd_pins rst_processor_1_100M/slowest_sync_clk]
  connect_bd_net -net v_hdmi_txss1_irq [get_bd_pins v_hdmi_txss1/irq] [get_bd_pins hdmi_txss_irq]
  connect_bd_net -net v_mix_0_interrupt [get_bd_pins v_mix_0/interrupt] [get_bd_pins Mixer_irq]
